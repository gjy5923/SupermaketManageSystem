...
public class RandomValue {
    ...
    private static String[] kind = "日用品,零食,学习用品,电子产品,其他".split(",");
    ...
    public static String getXh(){
        ...
        sb.append("2021");
        int xh1 = getNum(1, 9999);
        if(xh1<10){
            sb.append("00000").append(xh1);
        } else if (xh1<100) {
            sb.append("0000").append(xh1);
        }else if(xh1<1000){
            sb.append("000").append(xh1);
        }else {
            sb.append(xh1);
        }
        return sb.toString();
    }
    public static String getuserNum(String data){
        StringBuilder sb = new StringBuilder();
        ...
        if(xh1<10){
            ...
            sb.append("00").append(xh1);
        }else if(xh1<1000){
            sb.append("0").append(xh1);
        }else {
            sb.append(xh1);
        }
        return sb.toString();
...
//随机产生商品号
    public static String getGoodsNum(){
        StringBuilder sb = new StringBuilder();
        sb.append("2021");
        int gn = getNum(1, 9999);
        if(gn<10){
            sb.append("000").append(gn);
        } else if (gn<100) {
            sb.append("00").append(gn);
        }else if(gn<1000){
            sb.append("0").append(gn);
        }else {
            sb.append(gn);
        }
        return sb.toString();
...
//随机生成日期
    public static String randomDate(){
        ...
        int year=rndYear.nextInt(2)+2020;  //生成[2002,2020]的整数；年
...
//            mapItem.put("xh", getXh());
//            mapItem.put("name", getChineseName());
//            mapItem.put("sex", name_sex);
//            mapItem.put("road", getRoad());
//            mapItem.put("tel", getTel());
//            mapItem.put("email", getEmail(6,9));
//            map.put(i, mapItem);
//        }
//        for (int i=0;i<100;i++) {
//            Map m1 = map.get(i);
//            for(Object key:m1.keySet()){
//                System.out.print(String.valueOf(key)+"----"+m1.get(key)+";");
//            }
//            System.out.println();
//        }
